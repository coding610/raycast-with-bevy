    ...
    for wall_pos in wall_positions {
        if wall_pos.1 {
            ...
            for pos in 0..adjusted_wall_positions.len() {
                adjusted_wall_positions[pos].0 *= TILESIZE as usize;
                adjusted_wall_positions[pos].1 *= TILESIZE as usize;
                adjusted_wall_positions[pos].0 += (TILESIZE / 2.0) as usize;
                adjusted_wall_positions[pos].1 += (TILESIZE / 2.0) as usize;
            }
            ...
            for new_box_pos_x in (box_x_min..(box_x_max + TILESIZE as usize)).step_by(TILESIZE as usize) {
                for new_box_pos_y in (box_y_min..(box_y_max + TILESIZE as usize)).step_by(TILESIZE as usize) {
